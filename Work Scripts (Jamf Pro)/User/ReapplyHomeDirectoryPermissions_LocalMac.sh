...
find /Users/$LoggedInUser -type d -mindepth 1 -maxdepth 1 -not -name "Applications" -not -name "Public" -not -name "jnlp-applet" -not -name "cupit" -not -name "Creative Cloud Files" -not -name "Bauer Group" -print0 | xargs -0 chmod 700
