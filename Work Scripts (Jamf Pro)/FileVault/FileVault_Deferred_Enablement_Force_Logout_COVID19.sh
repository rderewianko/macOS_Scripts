...
Disk encryption is a GDPR requirement" -button1 "ok" defaultbutton "1" -timeout 5 &
...
Please select an option within 1 hour or the currently selected option will be automatically selected" -timeout 3600 -countdown -alignCountdown center -lockHUD -showDelayOptions "$deferralOption1, $deferralOption2, $deferralOption3, $deferralOption4"  -button1 "Select" -defaultButton "1"
