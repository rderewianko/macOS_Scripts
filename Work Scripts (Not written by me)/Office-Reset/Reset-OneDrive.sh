...
echo "Office-Reset: Starting Reset-OneDrive"
...
echo "Office-Reset: OneDrive closed"
...
if [ -d "/Applications/OneDrive.app" ]; then
	...
	if ! is-at-least 19000.0 $APP_VERSION && is-at-least 10.12 $OS_VERSION; then
...
echo "Office-Reset: Finished Reset-OneDrive"
exit 0